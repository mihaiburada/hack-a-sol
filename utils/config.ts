...
export const GOOGLE_OAUTH_CLIENT_SECRET= process.env.NEXT_PUBLIC_GOOGLE_OAUTH_CLIENT_SECRET
export const GOOGLE_MAPS_KEY = 'AIzaSyAAL70plNUSm188wakHJCRU-FWm_mnTpV4'
export const GITHUB_OAUTH_CLIENTID =process.env.NEXT_PUBLIC_GITHUB_ID
export const GITHUB_OAUTH_CLIENT_SECRET = process.env.NEXT_PUBLIC_GITHUB_SECRET
